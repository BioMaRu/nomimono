...
<section class="nm-table-container _mgt-8">
	<table class="nm-table is-variant-compact">
		...
		<tbody>
			<tr
				><td><code class="_cl-accent">{`_bfvsblt-hd${suffix}`}</code></td><td
					>backface-visibility: hidden</td
				></tr
			>
			<tr
				><td><code class="_cl-accent">{`_bfvsblt-vsb${suffix}`}</code></td><td
					>backface-visibility: visible</td
				></tr
			>
		</tbody>
	</table>
