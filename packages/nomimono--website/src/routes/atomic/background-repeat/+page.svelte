...
<section class="nm-table-container _mgt-8">
	<table class="nm-table is-variant-compact">
		...
		<tbody>
			<tr
				><td><code class="_cl-accent">{`_bgrp-rp${suffix}`}</code></td><td
					>background-repeat: repeat</td
				></tr
			>
			<tr
				><td><code class="_cl-accent">{`_bgrp-rpx${suffix}`}</code></td><td
					>background-repeat: repeat-x</td
				></tr
			>
			<tr
				><td><code class="_cl-accent">{`_bgrp-rpy${suffix}`}</code></td><td
					>background-repeat: repeat-y</td
				></tr
			>
			<tr
				><td><code class="_cl-accent">{`_bgrp-nrp${suffix}`}</code></td><td
					>background-repeat: no-repeat</td
				></tr
			>
			<tr
				><td><code class="_cl-accent">{`_bgrp-sp${suffix}`}</code></td><td
					>background-repeat: space</td
				></tr
			>
			<tr
				><td><code class="_cl-accent">{`_bgrp-r${suffix}`}</code></td><td
					>background-repeat: round</td
				></tr
			>
		</tbody>
	</table>
