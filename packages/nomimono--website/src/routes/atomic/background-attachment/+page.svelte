...
<section class="nm-table-container _mgt-8">
	<table class="nm-table is-variant-compact">
		...
		<tbody>
			<tr
				><td><code class="_cl-accent">{`_bgatm-sc${suffix}`}</code></td><td
					>background-attachment: scroll</td
				></tr
			>
			<tr
				><td><code class="_cl-accent">{`_bgatm-f${suffix}`}</code></td><td
					>background-attachment: fixed</td
				></tr
			>
			<tr
				><td><code class="_cl-accent">{`_bgatm-lc${suffix}`}</code></td><td
					>background-attachment: local</td
				></tr
			>
		</tbody>
	</table>
